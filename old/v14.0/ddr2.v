...
module ddr2 (
    ...
    initial begin
	    ...
	    // read init file
	    $display("readmemh...");
            $readmemh("/home/leo/cpu/vault.memo/v13.0/vmlinux.mem",buf_mem);	    
            for (cnt=32'h0; cnt<32'h400000; cnt=cnt+16) begin
                memory[cnt/16+17'h10000] <= {
		       buf_mem[21'h100000+cnt+15],buf_mem[21'h100000+cnt+14],buf_mem[21'h100000+cnt+13],buf_mem[21'h100000+cnt+12],
		       buf_mem[21'h100000+cnt+11],buf_mem[21'h100000+cnt+10],buf_mem[21'h100000+cnt+ 9],buf_mem[21'h100000+cnt+ 8],
		       buf_mem[21'h100000+cnt+ 7],buf_mem[21'h100000+cnt+ 6],buf_mem[21'h100000+cnt+ 5],buf_mem[21'h100000+cnt+ 4],
		       buf_mem[21'h100000+cnt+ 3],buf_mem[21'h100000+cnt+ 2],buf_mem[21'h100000+cnt+ 1],buf_mem[21'h100000+cnt+ 0]
		      };
		      //$display ("%h %h" , memory[cnt/16+17'h10000] , cnt );
            end
    ...
    // buffer for init file
    reg [7:0] buf_mem [8*1024*1024-1:0];
